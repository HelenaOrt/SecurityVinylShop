...
insert into purchase(order_number, client_id, quantity, purchase_date, vinyl_id) values('ASD543', 1, 200, now(), 1);
insert into purchase(order_number, client_id, quantity, purchase_date, vinyl_id) values('ASD54', 1, 1, now(), 1);
